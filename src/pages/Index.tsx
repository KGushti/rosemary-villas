    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative bg-blue-900 text-white py-16 md:py-24">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">فيلات روزماري - RoseMary villa's</h1>
            <p className="text-xl md:text-2xl mb-8">
              استمتع بإقامة مميزة في أفخم الفيلات بمنطقة تاجوراء، طرابلس
            </p>
      ...
      <section className="py-16 bg-cream-light">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">لماذا تختار فيلات روزماري؟</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                نقدم أفضل الفيلات المجهزة بأحدث التقنيات وأرقى الخدمات لضمان راحتك.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                نضمن لك ولعائلتك الخصوصية التامة والراحة المطلقة أثناء إقامتك في فيلاتنا.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                تقع فيلاتنا في منطقة هادئة وراقية في الباعيش، تاجوراء، سهلة الوصول من مختلف مناطق طرابلس.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-3xl font-bold">فيلات مميزة</h2>
