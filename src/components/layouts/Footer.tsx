    ...
    <footer className="bg-gray-900 text-white mt-16">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h2 className="text-2xl font-bold mb-4">فيلات روزماري - RoseMary villa's</h2>
            <p className="text-gray-300 mb-4">
              استمتع بإقامة مميزة في أجمل فيلات روزماري بمنطقة تاجوراء في طرابلس
            </p>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="https://www.facebook.com/rosemary.ly" target="_blank" rel="noopener noreferrer" className="bg-blue-resort/20 hover:bg-blue-resort/30 p-2 rounded-full transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5">
                  <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path>
                </svg>
              </a>
              <a href="https://www.instagram.com/rosemary.ly" target="_blank" rel="noopener noreferrer" className="bg-blue-resort/20 hover:bg-blue-resort/30 p-2 rounded-full transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5">
        ...
        <div className="border-t border-gray-800 mt-8 pt-6 text-center text-gray-400">
          <p>جميع الحقوق محفوظة © {new Date().getFullYear()} - فيلات روزماري</p>
        </div>
      </div>
    </footer>
  );
